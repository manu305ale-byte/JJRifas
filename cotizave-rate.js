...
window.addEventListener('load',function(){
  ...
  document.getElementById('loginAdminBtn')?.addEventListener('click',function(){setTimeout(loadAdmin,600)});
  document.getElementById('openAdminBtn')?.addEventListener('click',function(){setTimeout(loadAdmin,600)});
